...
def is_able_to_connect_to_left_station(p: int, s: int, node: Node, place: Tuple[float],
...
def is_able_to_connect_to_right_station(p: int, s: int, node: Node, place: Tuple[float],
                                        comm_dist: np.ndarray, comm_dist2gtw: np.ndarray,
                                        gtw: Tuple[float]) -> bool:
    """
...
def is_able_to_connect_unbusy_station(p: int, s: int, node: Node, place: Tuple[float],
                                      comm_dist: np.ndarray, comm_dist2gtw: np.ndarray,
                                      gtw: Tuple[float]) -> bool:
    """
...
def check_station_connection(
    ...
    otherwise
    """
    if (is_able_to_connect_to_left_station(i, j, node, place, comm_dist, comm_dist2gtw, gtw) and
            is_able_to_connect_to_right_station(i, j, node, place, comm_dist, comm_dist2gtw, gtw)
            and is_able_to_connect_unbusy_station(i, j, node, place, comm_dist,
                                                  comm_dist2gtw, gtw)):
        return True
    return False
